...
const getAllAcademicYear = async (req, res) => {
    try {
        ...
        return res.status(200).json({message:"List of all academic year!", data: rows, total: count, page, limit})
    } catch (error) {
...
const getAcademicYearById = async (req, res) => {
    ...
    try {
        const academicId = req.params.u_id
        ...
        res.status(200).json({message:"Academic Year found!", data: academicYear })
    } catch (error) {
