...
const setActivClass = async (req, res) => {
    try {
        const classId = req.params.u_id 
        ...
        await Class.update({is_active: false}, {where: {}});
...
module.exports = {
    createClass, getAllClass, getClassById, updateClass,deleteClass, setActivClass
}